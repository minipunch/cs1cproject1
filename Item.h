 ...
 *
 * Structure for the manipulation of an item
 * Manages all actions related to an item in the store
 *
 */
class Item {
private:
...
/*!
 * \brief The ItemSort struct
 *  Manages information related to an item that is sorted.
 */
struct ItemSort
{
	int property;
